...
const calculatorTool = { type: "function", function: { name: "calculate_vector",
  description: "Pure vector arithmetic. Choose one operation. negate returns -values; multiply_scalar returns values*scalar; add_scalar returns values+scalar; classify_threshold labels supplied values rise/fall/stable around Â±threshold.",
