...
export const RULE_FACTORIAL_V5 = Object.freeze({
  schema: "ik.rule-given-factorial-preregistration.v5",
  run_id: "rule-given-execution-v5-preregistered-20260817-001",
  aborted_predecessor_run_id: "rule-given-execution-v4-preregistered-20260817-001",
  source_run_id: "sign-stratified-practice-preregistered-20260816-002",
  randomization_seed: "ik-rule-given-execution-v5-20260817",
  context_count: 20,
...
export function buildRuleFactorialV5Schedule(protocol = RULE_FACTORIAL_V5) {
